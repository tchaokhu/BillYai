 ...
 *
 * ผ่าน spike S3 แล้ว (2026-08-26) — สแกนจริงด้วยกสิกรไทย เกียรตินาคินภัทร และ ttb
 * ทั้งสามเจ้าอ่านติดและ**ขึ้นยอดให้เอง** ผลเต็มอยู่ใน `docs/SPIKE-PHASE0.md`
 */
 ...
 * S3 ยิงทั้งสองแบบกับสามธนาคารแล้ว **อ่านได้หมดทั้งคู่** จึงคง default เป็นแบบเรียง
 * ตาม tag เพราะตรงตัวอย่างในสเปก · `countryFirst` ไม่ได้ถูกลบทิ้งเพราะกลุ่มตัวอย่าง
 * มีแค่สามเจ้า ธนาคารที่ยังไม่ได้ลองอาจเลือกข้าง — เก็บไว้เป็นทางถอยที่สลับได้โดย
 * ไม่ต้องแก้โค้ด ไม่ใช่ตัวเลือกที่ผู้ใช้ปลายทางเห็น
 */
