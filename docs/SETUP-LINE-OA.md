...
ได้ **บัญชีฟรี (Unverified)** มา — แผนฟรีของไทยให้ส่ง **300 ข้อความ/เดือน**
(ยิง `GET /v2/bot/message/quota` กับบัญชีจริงแล้วได้ `{"type":"limited","value":300}` เมื่อ 2026-08-29)
