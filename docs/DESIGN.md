...
| D54 | ส่วนปรับพิมพ์เองได้ไหม | **ได้ แต่ไม่เปลี่ยนยอดที่จ่ายจริง — มันเป็นตัวทานชั้นที่สอง** · พิมพ์เอง = ติดลบได้ (ส่วนลด) · คำนวณเอง = ติดลบไม่ได้ | สามตัวเลขผูกกันด้วย `ยอดที่จ่ายจริง = ผลรวม Item + ส่วนปรับ` แก้ได้แค่สองตัว · ให้ส่วนปรับเป็นตัวตั้งแล้วยอดที่จ่ายจริงเป็นตัวคำนวณ = **ตัวทานหายทั้งตัว** ลืมจดรายการแล้วบิลลง ledger น้อยกว่าใบเสร็จเงียบๆ · ที่เลือกคือยอดที่จ่ายจริงเป็นตัวตั้งเสมอ ค่าที่พิมพ์เองไปเทียบ `ยอด − ส่วนปรับ` กับผลรวม Item จริง ไม่ตรง = เตือน · ส่วนลดกับคูปองเป็นของจริง แต่ค่าติดลบที่ระบบคำนวณเองแยกไม่ออกจากการจดตก **เกณฑ์คือมีคนตั้งใจพิมพ์หรือไม่ ไม่ใช่เครื่องหมายของตัวเลข** |
