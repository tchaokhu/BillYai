...
Surcharge ในตาราง `expense` ยังจำเป็นจริง แต่เป็นของ **โหมด itemized ซึ่งเป็นงานของ LIFF**
...
create table expense (
  ...
  surcharge_satang bigint not null default 0 check (surcharge_satang >= 0),  -- D50 · migration 0003 ยังไม่รัน ไปพร้อม M9
